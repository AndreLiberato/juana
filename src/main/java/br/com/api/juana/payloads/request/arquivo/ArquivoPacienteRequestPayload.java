...
public class ArquivoPacienteRequestPayload extends ArquivoRequestPayload {
	@NotNull(message = "{prescritorId.not.blank}")
	private UUID prescritorId;

	public ArquivoPacienteRequestPayload(byte[] bytes, String nome, String tipo, UUID prescritorId) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArquivoPacienteRequestPayload other = (ArquivoPacienteRequestPayload) obj;
		return Objects.equals(prescritorId, other.prescritorId);
	}

	@Override
	public String toString() {
		return "ArquivoPacienteRequestPayload [nome=" + nome + ", tipo=" + tipo + ", prescritorId=" + prescritorId
				+ "]";
	}
