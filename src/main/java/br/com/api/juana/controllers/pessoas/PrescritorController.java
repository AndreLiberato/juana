...
//	@PostMapping
//	public ResponseEntity<?> store(@Valid @RequestBody PrescritorRequestPayload prescritorPayload) {
...
//
//	@PutMapping("/{id}")
//	public ResponseEntity<?> update(@Valid @RequestBody PrescritorRequestPayload prescritorPayload,
